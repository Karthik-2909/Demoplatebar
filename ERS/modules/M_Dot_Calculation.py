...
from ultracoolantProp_direct import *

def M_DOT_H(T_,P_,omega_,Q,m_dot_a,m_dot_w,T_sat,Rho_a,h_a,h_w,C_p_a,Mu_a,k_a,Pr_a,P_w_amb,Fluid):
    if(Fluid=="compressed_air"):
...
def M_DOT_H_None(T_,P_,omega_,Q,m_dot_a,m_dot_w,T_sat,Rho_a,h_a,h_w,C_p_a,Mu_a,k_a,Pr_a,P_w_amb,Fluid):
    if(Fluid=="compressed_air"):
